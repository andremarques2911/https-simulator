...
/**
 * Número gerato aleatóriamente:
 *      a: 22548155496845254710235689745815
 * Valor de A obtido através de g^a mod p e enviado para o professor:
 ...
 * Valor de B gerado e enviado pelo professor:
 *      B: 
 * Valor da mensagem cifrada gerada e enviada pelo professor
 ...
 * Valor de V obtido através de B^a mod p:
 ...
 * Valor de S obtido através de SHA256(V)
 *      S: F4729CCB6D2E9597E2D14FF1E9BCB51119969F10626071F5DC90214D0294B6CB
 * Valor de K(que é a key) obtida através dos 128 primeiros bits de S
 *      K: F4729CCB6D2E9597E2D14FF1E9BCB511
 * Valor de IV, obtido através dos 128 primeiros bits da mensagem cifrada enviada pelo professor
 *      IV: 8BEB2187C844936BAF6E96A77953C827
 * Valor da mensagem decifrada:
 ...
 * Valor da mensagem invertida cifrada:
...
/**
 * author: Andre Luiz Marques Macrini Leite
 * 2021/2
 */
class HTTPS {
    fun simulate() {
        ...
        // Obtem o valor de a
        val a = generate_a(p)
        // Calcula o valor de A utilizando g^a mod p e transforma em hexadecimal para ser enviado ao professor
        val A = toHex(g.modPow(a, p).toByteArray()).substring(2)
        // Calcula o valor de V utilizando B^a mod p
        val V = B.modPow(a, p)
        // Aplica sha256 no V para obter o valor de S
        val S = sha256(V.toByteArray())
        // Pega os primeiros 128 bit de S e transforma em hexadecimal para obter o valor de K
...
//        val encryptedMsg = "CD1ECCB9EE60C4B409968124DA06B0C30A172085830AD2F0EC76E140ABE88A22"
        ...
        // Pega os 128 primeiros bits da mensagem criptografada
        val IV = encryptedMsg.take(32)
        // Pega o resto da mensagem criptografada, excluindo os 128 primeiros bits
        val msg = encryptedMsg.takeLast(encryptedMsg.length - 32)
        // Decifra a mensagem enviada pelo professor
        val decryptedMsg = decryptMessage(msg, fromHexString(K), fromHexString(IV))
        // Inverte a mensagem enviada pelo professor
        val reversedMsg = decryptedMsg.reversed()
        // Cifra a mensagem enviada pelo professor
